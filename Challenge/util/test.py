...
def test(model, test_data_loader, device):
    ...
    with torch.no_grad():  # No need to track gradients
        for image, segment_image in tqdm.tqdm(test_data_loader):
            ...
            # Sum the IoU and F1 scores for averaging later
            ...
            # Optionally, save images or other data
            # one_hot_to_mask(out_image[0], file_name='out_test_rgb.png')  # Example to save output mask

    # Calculate average IoU and F1 score across the test dataset
